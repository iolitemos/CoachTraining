import { PublicCompetitionMatch } from './public-routine-calendar.model';
...
export interface ParentRoutinePlanCalendar { athleteId: number; athleteNickname: string | null; athleteFullName: string; dates: ParentRoutinePlanDate[]; competitionMatches: PublicCompetitionMatch[]; }
